var translator = (function() {  //iife
  ...
  var frenchLexicon = {  //an object.  Keys are english words, values are the spanish translation.
    merry: "joyeux",
    christmas: "noel",
    happy: "content",
    newVar: "nouveau",
...
// that accepts the argument "inputPH".
      ...
      for (i = 0; i < strArray.length; i++) {   //iterate over each item in the new array
          for (word in frenchLexicon) {        //iterate over each word in the spanishLexicon array
